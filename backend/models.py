...
The real models live in `backend/database/models.py`. This module re-exports
the common symbols so other modules that still import `models` keep working.
"""

from database.extensions import db
from database.models import User, Event, Complaint, Book, Borrowing

__all__ = ["db", "User", "Event", "Complaint", "Book", "Borrowing"]
